...
final class NumericalMonitor {
    ...
    enum Probe: Int, CaseIterable {
        ...
        var stageLabel: String {
            ...
            case .selfGateAdd: return "self-attention branch/gate input"
            ...
            case .crossGateAdd: return "cross-attention branch/gate input"
            ...
            case .mlpGateAdd: return "MLP branch/gate input"
