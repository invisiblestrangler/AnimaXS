...
The production Metal DiT path is validated through H006. Do **not** replace it with `DiTBlockCPU` or retain fully dequantized weights in nested Swift arrays. Continue from the completed vertical slice:
