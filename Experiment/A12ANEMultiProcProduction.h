...
// Once the physical-device A/B is accepted, these helpers can be moved into the
// runtime without changing the Swift scheduler API below.
#import "A12ANEMultiProcResidencyStage2MMemSafe.h"
